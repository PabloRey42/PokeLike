    ...
    public class DatabaseSeeder
    {
        public static void SeedDatabase(ExerciceMonsterContext context)
        {
            if (!context.Monsters.Any() && !context.Spells.Any())
            {
                ...
                var pikachu = new Monster { Name = "Pikachu", Health = 100, Spells = { thunderShock, quickAttack, thunderbolt, ironTail } };
                var charmander = new Monster { Name = "Charmander", Health = 95, Spells = { ember, flamethrower, scratch, dragonRage } };

                var squirtle = new Monster
                {
                    Name = "Squirtle",
                    Health = 110,
                    Spells = { new Spell { Name = "Water Gun", Damage = 40, Description = "Shoots a stream of water at the target." },
                ...
                var bulbasaur = new Monster
                {
                    Name = "Bulbasaur",
                    Health = 105,
                    Spells = { new Spell { Name = "Vine Whip", Damage = 45, Description = "Strikes the target with slender vines." },
                ...
                var eevee = new Monster { Name = "Eevee", Health = 95, Spells = { quickAttack, scratch, thunderbolt, flamethrower } };
