...
namespace PokeLike.Services
{
    public static class DatabaseSeeder
    {
        public static void SeedDatabase(ExerciceMonsterContext context)
        {
            try
            {
                Console.WriteLine("Tentative d'accès à la base de données...");
                ...
                {
                    Console.WriteLine("La base de données est déjà initialisée.");
                }
            }
            catch (Exception ex)
            {
                Console.WriteLine("Erreur lors de la connexion ou de l'initialisation de la base de données :");
                Console.WriteLine(ex.Message);
                throw; // Rejeter l'exception pour la remonter à l'appelant
            }
        }
    }
}
